...
//                  The driver may be suboptimal, since much  of
...
int16_t i16IMU_readRawAccelX();
int16_t i16IMU_readRawAccelY();
int16_t i16IMU_readRawAccelZ();
int16_t i16IMU_readRawGyroX();
int16_t i16IMU_readRawGyroY();
int16_t i16IMU_readRawGyroZ();

//Returns the values as floats.  Inside, this calls readRaw___();
float fIMU_readFloatAccelX();
float fIMU_readFloatAccelY();
float fIMU_readFloatAccelZ();
float fIMU_readFloatGyroX();
float fIMU_readFloatGyroY();
