...
//#define ledYELLOW	    PINA6   /*  Yellow LED connected                */ /*Removed by Lars Marius so the port can be used for battery monitoring*/
#define ledRED		    PINA6   /*  Green LED connected                 */ /*originally set to pin7	*/

/*	Battery																*/
#define batPORT			PORTA	/*	Battery is connected to port A		*/
#define batReg			DDRA	/*	Port A register used				*/
#define batInput		PINA7	/*	The voltage from volt.dev conn.		*/
