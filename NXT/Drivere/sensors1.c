 ...
 */
#include "FreeRTOS.h"
#include "sensors1.h" // 10/04/15 takashic
#include "nxt_avr.h"
...
void sp_set(int port, int pin, int val)
{
  int at_pin = sensor_pins[port].pins[pin];
  if (val)
...
void sp_set_power(int port, int val)
{
