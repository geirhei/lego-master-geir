 ...
 */
static unsigned char display_buffer[DISPLAY_DEPTH+1][DISPLAY_WIDTH];
...
static const unsigned char font[N_CHARS][FONT_WIDTH] = {
...
static void display_unsigned_worker(unsigned long val, unsigned long places, unsigned long sign)
{
...
{
  return (unsigned char *)display_buffer;
}
...
void display_init(void)
{
  ...
  nxt_lcd_init((unsigned char *)display_buffer);
}
...
void display_test(void)
{
  ...
  while (1) {
    ...
    display_goto_xy(0, 7);
    display_string("TIME ");
    display_unsigned(xTaskGetTickCount(), 0);
